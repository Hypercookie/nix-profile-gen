  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "SUFeedURL" "SUEnableAutomaticChecks" "SUScheduledCheckInterval" "SUAllowsAutomaticUpdates" "SUAutomaticallyUpdate" "SUSkippedVersion" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-mcneel-rhinoceros" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Rhinoceros (com.mcneel.rhinoceros) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}