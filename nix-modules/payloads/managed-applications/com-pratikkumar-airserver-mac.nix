  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "SUFeedURL" "SUEnableAutomaticChecks" "SUScheduledCheckInterval" "SUAllowsAutomaticUpdates" "SUAutomaticallyUpdate" "SUSendProfileInfo" "UseLionStyleFullscreen" "UserDeviceName" "UserLosslessAudioReceiverName" "autoLaunch" "com.airserverapp.audioBufferSize2" "com.airserverapp.PasswordType" "com.airserverapp.alwaysOnTop" "com.airserverapp.dualAirplay" "com.airserverapp.linkMasterVolume" "com.airserverapp.mirroringOptimizedFor2" "com.airserverapp.slowNetwork" "com.airserverapp.SoftwareDecoderOnly" "showInDock" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-pratikkumar-airserver-mac" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "AirServer (com.pratikkumar.airserver-mac) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}