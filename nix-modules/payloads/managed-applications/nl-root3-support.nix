  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "Title" "Logo" "LogoDarkMode" "NotificationIcon" "StatusBarIcon" "StatusBarIconSFSymbol" "StatusBarIconNotifierEnabled" "CustomColor" "CustomColorDarkMode" "HideFirstRow" "HideSecondRow" "ErrorMessage" "ShowWelcomeScreen" "FooterText" "OpenAtLogin" "InfoItemOne" "InfoItemTwo" "InfoItemThree" "InfoItemFour" "InfoItemFive" "InfoItemSix" "UptimeDaysLimit" "PasswordExpiryLimit" "PasswordLabel" "StorageLimit" "FirstRowTitleLeft" "FirstRowSubtitleLeft" "FirstRowTypeLeft" "FirstRowLinkLeft" "FirstRowSymbolLeft" "FirstRowTitleMiddle" "FirstRowSubtitleMiddle" "FirstRowTypeMiddle" "FirstRowLinkMiddle" "FirstRowSymbolMiddle" "FirstRowTitleRight" "FirstRowSubtitleRight" "FirstRowTypeRight" "FirstRowLinkRight" "FirstRowSymbolRight" "SecondRowTitleLeft" "SecondRowSubtitleLeft" "SecondRowTypeLeft" "SecondRowLinkLeft" "SecondRowSymbolLeft" "SecondRowTitleMiddle" "SecondRowSubtitleMiddle" "SecondRowTypeMiddle" "SecondRowLinkMiddle" "SecondRowSymbolMiddle" "SecondRowTitleRight" "SecondRowSubtitleRight" "SecondRowTypeRight" "SecondRowLinkRight" "SecondRowSymbolRight" "ExtensionTitleA" "ExtensionSymbolA" "ExtensionTypeA" "ExtensionLinkA" "ExtensionTitleB" "ExtensionSymbolB" "ExtensionTypeB" "ExtensionLinkB" "HideMajorUpdates" "UpdateText" "HideFirstRowInfoItems" "HideSecondRowInfoItems" "HideThirdRowInfoItems" "HideFirstRowButtons" "HideSecondRowButtons" "PasswordType" "OnAppearAction" "DisablePrivilegedHelperTool" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-nl-root3-support" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "SupportApp by Root3 (nl.root3.support) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}