  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "DisablePersonalSync" "DisableTutorial" "DefaultFolderLocation" "AutomaticUploadBandwidthPercentage" "UploadBandwidthLimited" "DownloadBandwidthLimited" "HideDockIcon" "OpenAtLogin" "SharePointOnPremFrontDoorUrl" "SharePointOnPremPrioritizationPolicy" "SharePointOnPremTenantName" "SharePointOnPremPrioritzationPolicy" "DefaultToBusinessFRE" "EnableAddAccounts" "FilesOnDemandEnabled" "IsHydrationToastAllowed" "HydrationDisallowedApps" "EnableODIgnore" "EnableSyncAdminReports" "EnableAllOcsiClients" "DisableAutoConfig" "DisableHydrationToast" "BlockExternalSync" "AllowTenantList" "BlockTenantList" "KFMOptInWithWizard" "KFMSilentOptIn" "KFMSilentOptInDesktop" "KFMSilentOptInDocuments" "KFMSilentOptInWithNotification" "KFMBlockOptIn" "KFMBlockOptOut" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-microsoft-OneDrive" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Microsoft OneDrive (com.microsoft.OneDrive) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}