  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "AutoUpdateState" "AutoUpdateRollOutBucketIndex" "PreferH264HardwareDecoder" "PreferFFMPEGDecoder" "MenuBarAutoShowDelayEnabled" "MenuBarAutoShowDelay" "UDPStackParameters" "HockeySDKAutomaticallySendCrashReports" "HockeySDKCrashReportActivated" "TraceOn" "DisplaySplashScreen" "BITApplicationWasLaunched" "CEIPEnabled" "PreferMetalRendering" "HDXOverUDPAllowed" "LegacyPublishedContentEnabled" "NetDisruptBrightness" "SecurityComplianceMode" "SecurityAllowedTLSVersions" "SSLCertificateRevocationCheckPolicy" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-citrix-receiver-nomas" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Citrix Receiver (com.citrix.receiver.nomas) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}