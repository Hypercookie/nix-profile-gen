  ...
  payloadModule = {
    options = {
              ...
              type = types.nullOr (types.submodule {
                options = {
                  ...
                  ExtensionUnpublishedAvailability = lib.mkOption {
                    ...
                    default = null;
                    description = "If this policy is enabled, extensions that are unpublished on the Chrome Web Store will be disabled in Google Chrome";
                  };
      ...
      PromotionsEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "Setting the policy to True or leaving it unset lets Google Chrome show users product promotional content.";
      };
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-google-Chrome" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Google Chrome (com.google.Chrome) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}