  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "log_file_dir" "log_file_name" "notifier_msg_title" "notifier_msg_installed" "notifier_msg_nopending" "notifier_msg_pending" "notifier_msg_uptodate" "notifier_msg_osupdatespending" "notifier_path" "notifier_sender_id" "datajar_notifier" "datajar_notifier_logout_button" "no_msg_category" "delete_secure_auth" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-uk-co-dataJAR-jamJAR" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "jamJAR (uk.co.dataJAR.jamJAR) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}