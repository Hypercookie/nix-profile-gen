  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "AllowedEmailDomains" "AutomaticallyDownloadExternalContent" "CalendarFirstDayOfWeek" "DefaultEmailAddressOrDomain" "NSRequiresAquaSystemAppearance" "DisableExport" "DisableImport" "DisableModernAuth" "DisablePreviewForSMIME" "DisableSignatures" "DisableDefaultAppSignature" "DisableSkypeMeeting" "DisableTeamsMeeting" "FirstRunExperienceCompletedO15" "kSubUIAppCompletedFirstRunSetup1507" "HideFoldersOnMyComputerRootInFolderList" "HideCanAddOtherAccountTypesTipText" "SignInOptions" "SendASmileEnabled" "SendAllTelemetryEnabled" "SendCrashReportsEvenWithTelemetryDisabled" "OverrideAccountConfigurationWindow" "kFRETelemetryConsentKey" "o365GroupsOobePromoTriggeredPref" "googlePromoTriggeredPref" "TrustO365AutodiscoverRedirect" "kFREEnterpriseTelemetryInfoKey" "kFREIntelligenceServicesConsentV2Key" "PII_And_Intelligent_Services_Preference" "DefaultWeatherLocation" "Weather_update_automatically" "EnableNewOutlook" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-microsoft-Outlook" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Microsoft Outlook (com.microsoft.Outlook) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}