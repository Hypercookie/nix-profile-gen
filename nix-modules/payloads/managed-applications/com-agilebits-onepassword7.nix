  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "OPPrefBiometryAllowed" "OPPrefPINAllowed" "OPPrefAppleWatchAllowed" "OPPrefMasterPasswordTimeoutInMinutesKey" "ConcealPasswords" "LockOnSleep" "LockOnScreenSaver" "LockOnMainAppExit" "LockOnUserSwitch" "LockOnIdle" "LockTimeout" "settingClearPasteboardAfterTimeout" "PasteboardClearTimeout" "OPPreferencesNotifyCompromisedWebsites" "OPPreferencesNotifyVaultAddedRemoved" "OPPreferencesNotifyOfTOTPCopy" "OPPreferencesWhatsNewDialogDisabled" "CheckForSoftwareUpdatesEnabled" "AutoInstallSoftwareUpdatesEnabled" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-agilebits-onepassword7" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "1Password 7 (com.agilebits.onepassword7) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}