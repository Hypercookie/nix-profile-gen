...

{
  options.programs.macprofile.payloads."managed-applications-com-barebones-bbedit" = {
    ...
    ScriptEditorBundleID = lib.mkOption {
      type = types.nullOr (types.str);
      default = "com.apple.ScriptEditor2";
