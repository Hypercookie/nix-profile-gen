...
in
{
  options.programs.macprofile.payloads."managed-applications-com-barebones-bbedit" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "BBEdit (com.barebones.bbedit) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}