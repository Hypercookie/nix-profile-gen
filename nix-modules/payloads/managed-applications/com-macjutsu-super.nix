  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "AuthAskUserToSavePassword" "AuthCredentialFailoverToUser" "AuthJamfComputerID" "AuthJamfCustomURL" "AuthMDMFailoverToUser" "DeadlineCountFocus" "DeadlineCountHard" "DeadlineCountSoft" "DeadlineDateFocus" "DeadlineDateHard" "DeadlineDateSoft" "DeadlineDaysFocus" "DeadlineDaysHard" "DeadlineDaysSoft" "DialogTimeoutRestartOrDefer" "WorkflowJamfPolicyTriggers" "DisplayAccessoryUserAuthFile" "DisplayAccessoryUpdateFile" "DisplayAccessoryUpgradeFile" "WorkflowZeroDateManual" "DeferralTimerFocus" "DialogTimeoutDefault" "DialogTimeoutInsufficientStorage" "DialogTimeoutPowerRequired" "DialogTimeoutSoftDeadline" "DialogTimeoutUserAuth" "DialogTimeoutUserChoice" "DialogTimeoutUserSchedule" "DisplayAccessoryDefaultFile" "DisplayAccessoryJamfPolicyTriggersFile" "DisplayAccessoryMacOSMajorUpgradeFile" "DisplayAccessoryMacOSMinorUpdateFile" "DisplayAccessoryNonSystemUpdatesFile" "DisplayAccessoryRestartWithoutUpdatesFile" "DisplayAccessoryType" "DisplayHelpButtonString" "DisplayHideProgressBar" "DisplayIconDarkFile" "DisplayIconLightFile" "DisplayIconFile" "DisplayIconSize" "InstallJamfPolicyTriggers" "InstallJamfPolicyTriggersWithoutRestarting" "ScheduleZeroDateRelease" "ScheduledInstallUserChoice" "TestMode" "WorkflowInstallNow" "ScheduleWorkflowActive" "TestBatteryLevel" "TestModeTimeout" "TestStorageUpdate" "TestStorageUpgrade" "ScheduleZeroDateManual" "ScheduleZeroDateSOFACustomURL" "ScheduledInstallDate" "ScheduledInstallDays" "ScheduledInstallReminder" "DeferralTimerDefault" "DeferralTimerError" "DeferralTimerMenu" "DeferralTimerWorkflowRelaunch" "DisplayHideBackground" "DisplayNotificationsCentered" "DisplaySilently" "DisplayUnmovable" "DisplayWarningButtonString" "InstallMacOSMajorUpgrades" "WorkflowRestartWithoutUpdates" "InstallMacOSMajorVersionTarget" "InstallNonSystemUpdatesWithoutRestarting" "InstallRapidSecurityResponses" "InstallMacOSBSIUpdates" "WorkflowDisableRelaunch" "WorkflowDisableUpdateCheck" "WorkflowOnlyDownload" "VerboseMode" ];
      ...
      InstallMacOSBSIUpdates = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "Allows the super workflow to install macOS BSI Updates";
      };
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-macjutsu-super" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "S.U.P.E.R.M.A.N (com.macjutsu.super) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}