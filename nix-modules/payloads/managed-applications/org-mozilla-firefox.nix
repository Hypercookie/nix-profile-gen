  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "EnterprisePoliciesEnabled" "PFC_SegmentedControl_0" "General_SegmentedControl" "Privacy_SegmentedControl" "Security_SegmentedControl" "BackgroundAppUpdate" "AppAutoUpdate" "AppUpdateURL" "Authentication" "BlockAboutAddons" "BlockAboutConfig" "BlockAboutProfiles" "BlockAboutSupport" "Bookmarks" "DefaultDownloadDirectory" "DisableAppUpdate" "DisableBuiltinPDFViewer" "PDFjs" "DisableDeveloperTools" "DisableFeedbackCommands" "DisableFirefoxAccounts" "DisableFirefoxScreenshots" "DisableFirefoxStudies" "DisableForgetButton" "DisableMasterPasswordCreation" "PrimaryPassword" "DisablePocket" "DisablePrivateBrowsing" "DisableProfileImport" "DisableProfileRefresh" "DisableSafeMode" "DisableSetDesktopBackground" "DisplayMenuBar" "DisableSystemAddonUpdate" "DisplayBookmarksToolbar" "DontCheckDefaultBrowser" "DownloadDirectory" "Extensions" "ExtensionSettings" "ExtensionUpdate" "_3rdparty" "EncryptedMediaExtensions" "HardwareAcceleration" "FirefoxHome" "GenerativeAI" "Homepage" "ShowHomeButton" "LocalFileLinks" "NewTabPage" "NoDefaultBookmarks" "OverrideFirstRunPage" "OverridePostUpdatePage" "PictureInPicture" "PromptForDownloadLocation" "RequestedLocales" "SanitizeOnShutdown" "SearchBar" "SearchEngines" "SearchSuggestEnabled" "Handlers" "DisabledCiphers" "DNSOverHTTPS" "Proxy" "SSLVersionMin" "SSLVersionMax" "NetworkPrediction" "Cookies" "DisableFormHistory" "DisablePasswordReveal" "DisableTelemetry" "EnableTrackingProtection" "FlashPlugin" "InstallAddonsPermission" "OfferToSaveLogins" "OfferToSaveLoginsDefault" "PasswordManagerEnabled" "Permissions" "PopupBlocking" "Certificates" "DisableSecurityBypass" "SecurityDevices" "UserMessaging" "LegacySameSiteCookieBehaviorEnabled" "LegacySameSiteCookieBehaviorEnabledForDomainList" "WebsiteFilter" "AllowedDomainsForApps" "AutoLaunchProtocolsFromOrigins" "CaptivePortal" "Preferences" "SupportMenu" "MicrosoftEntraSSO" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-org-mozilla-firefox" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Firefox (org.mozilla.firefox) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}