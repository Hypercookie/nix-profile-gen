  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "ClientMode" "FailClosed" "FileChangesRegex" "AllowedPathRegex" "BlockedPathRegex" "EnableBadSignatureProtection" "EnablePageZeroProtection" "EnableSysxCache" "AboutText" "MoreInfoURL" "EventDetailURL" "EventDetailText" "UnknownBlockMessage" "BannedBlockMessage" "ModeNotificationMonitor" "ModeNotificationLockdown" "SyncBaseURL" "SyncEnableCleanSyncEventUpload" "ClientAuthCertificateFile" "ClientAuthCertificatePassword" "ClientAuthCertificateCN" "ClientAuthCertificateIssuerCN" "ServerAuthRootsData" "ServerAuthRootsFile" "MachineOwner" "MachineID" "MachineOwnerPlist" "MachineOwnerKey" "MachineIDPlist" "MachineIDKey" "EventLogType" "EventLogPath" "MailDirectory" "MailDirectoryFileSizeThresholdKB" "MailDirectorySizeThresholdMB" "MailDirectoryEventMaxFlushTimeSec" "EnableMachineIDDecoration" "MetricFormat" "MetricURL" "MetricExportInterval" "MetricExportTimeout" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-google-santa" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Santa (Google) (com.google.santa) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}