  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "optionalFeatures" "osVersionRequirements" "userExperience" "userInterface" "json_url" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-github-macadmins-Nudge" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Nudge (com.github.macadmins.Nudge) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}