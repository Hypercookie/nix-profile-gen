  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "ADDomain" "PFC_SegmentedControl_0" "DenyLocal" "DenyLocalExcluded" "DenyLoginUnlessGroupMember" "RecursiveGroupLookup" "Migrate" "MigrateUsersHide" "PasswordOverwriteSilent" "PasswordOverwriteOptional" "LocalFallback" "LDAPServers" "LDAPOverSSL" "AdditionalADDomains" "AdditionalADDomainList" "NTtoADDomainMappings" "AliasNTName" "AliasUPN" "IgnoreSites" "EULATitle" "EULASubTitle" "EULAText" "EULAPath" "CreateAdminUser" "CreateAdminIfGroupMember" "UseCNForFullName" "UseCNForFullNameFallback" "UserProfileImage" "DemobilizeUsers" "DemobilizeSaveAltSecurityIdentities" "DemobilizeForcePasswordCheck" "UserInputOutputPath" "UserInputLogo" "UserInputTitle" "UserInputMainText" "UserInputUI" "EnableFDE" "EnableFDERecoveryKey" "EnableFDERecoveryKeyPath" "EnableFDERekey" "LoginScreen" "UsernameFieldPlaceholder" "LoginLogo" "LoginLogoData" "LoginLogoAlpha" "BackgroundImage" "BackgroundImageData" "BackgroundImageAlpha" "AllowNetworkSelection" "DefaultSystemInformation" "PowerControlDisabled" "ManageSecureTokens" "SecureTokenManagementEnableOnlyAdminUsers" "SecureTokenManagementIconPath" "SecureTokenManagementOnlyEnableFirstUser" "SecureTokenManagementFullName" "SecureTokenManagementUID" "SecureTokenManagementPasswordLocation" "SecureTokenManagementPasswordLength" "SecureTokenManagementUsername" "MessagePasswordSync" "ScriptPath" "ScriptArgs" "UIDTool" "GUIDTool" "NotifyLogStyle" "KeychainCreate" "KeychainAddNoMAD" "CustomNoMADLocation" "LastUser" "KeychainReset" "GuestUser" "GuestUserAccounts" "GuestUserAccountPasswordPath" "GuestUserFirst" "GuestUserLast" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-menu-nomad-login-ad" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "NoMAD Login (menu.nomad.login.ad) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}