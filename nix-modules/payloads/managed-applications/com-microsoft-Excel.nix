...
in
{
  options.programs.macprofile.payloads."managed-applications-com-microsoft-Excel" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Microsoft Excel (com.microsoft.Excel) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}