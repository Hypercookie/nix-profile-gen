  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "ServerURL" "BasicAuth" "key" "SyncScripts" "SkipFacts" "GetGrains" "GetOhai" "CACert" "SSLClientKey" "SSLClientCertificate" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-github-salopensource-sal" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Sal (com.github.salopensource.sal) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}