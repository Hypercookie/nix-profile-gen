  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "BrandName" "BrandColor" "BrandLogo" "SupportUrl" "ChangePasswordUrl" "ChangePasswordMode" "SupportEmail" "SupportPhone" "ShowMenuToggle" "HiddenWidgets" "HiddenActions" "NotificationInterval" "NotificationTitle" "NotificationImage" "SoftwareUpdateNotificationMessage" "SoftwareUpdateNotificationButtonText" "AppUpdateNotificationMessage" "AppUpdateNotificationButtonText" "CustomColors" "IntuneMode" "SystemProfilerApps" "LogFolders" "Actions" "ShowDesktopInfo" "DesktopPosition" "DesktopInfoLevel" "DesktopInfoCustomItems" "DesktopInfoBackgroundColor" "DesktopInfoBackgroundOpacity" "DesktopInfoColorHighlight" "DesktopInfoFontSize" "CustomWidgetsPath" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-SupportCompanion" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Support Companion v1 (SupportCompanion) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}