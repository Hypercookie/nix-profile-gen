# Auto-generated from ProfileManifests: com.github.mpanighetti.install-or-defer.plist
# Domain: com.github.mpanighetti.install-or-defer
  ...
  payloadModule = {
    options = {
      ...
      _domain = lib.mkOption {
        internal = true;
        type = lib.types.str;
        default = "com.github.mpanighetti.install-or-defer";
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "InstallButtonLabel" "DeferButtonLabel" "DisablePostInstallAlert" "MessagingLogo" "SupportContact" "DeferralPeriod" "HardRestartDelay" "MaxDeferralTime" "PromptTimeout" "SkipDeferral" "UpdateDelay" "WorkdayStartHour" "WorkdayEndHour" "DiagnosticLog" "ManualUpdates" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-github-mpanighetti-install-or-defer" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Install or Defer (com.github.mpanighetti.install-or-defer) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}