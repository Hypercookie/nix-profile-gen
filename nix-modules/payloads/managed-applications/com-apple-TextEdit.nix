  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "PFC_SegmentedControl_DocSettings" "AddExtensionToNewPlainTextFiles" "HTMLEncoding" "CheckGrammarWithSpelling" "CheckSpellingWhileTyping" "CorrectSpellingAutomatically" "DataDetectors" "HeightInChars" "IgnoreHTML" "IgnoreRichText" "NSDocumentSuppressTempVersionStoreWarning" "NSFixedPitchFont" "NSFixedPitchFontSize" "NSFont" "NSFontSize" "PreserveDocumentWhitespace" "ShowPageBreaks" "ShowRuler" "SmartCopyPaste" "SmartLinks" "SmartQuotes" "SmartSubstitutionsEnabledInRichTextOnly" "TextReplacement" "PlainTextEncoding" "PlainTextEncodingForWrite" "RichText" "UseEmbeddedCSS" "UseInlineCSS" "UseTransitionalDocType" "UseXHTMLDocType" "WidthInChars" "author" "company" "copyright" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-apple-TextEdit" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "TextEdit (com.apple.TextEdit) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}