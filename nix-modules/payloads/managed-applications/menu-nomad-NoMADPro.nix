  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "AuthServer" "PFC_SegmentedControl_0" "LicenseFile" "PeriodicUpdateTime" "SignInCommand" "PFC_SegmentedControl_General" "UseKeychainPrompt" "UseKeychainPromptExlusions" "SignInLogo" "TitleSignIn" "LabelUsername" "LabelPassword" "DontShowWelcome" "AutoAuth" "CheckSafariExtension" "MessagePluginDisabled" "IgnoreDomainReachability" "LDAPServers" "KerberosRealm" "TicketsOnSignIn" "KerberosRenew" "KerberosShortNameAsk" "KerberosShortNameAskMessage" "KerberosShortName" "UseKeychain" "LocalPasswordSync" "LocalPasswordSyncOnMatchOnly" "LocalPasswordSyncMessage" "KeychainItems" "KeychainItemsDebug" "PFC_SegmentedControl_Password" "ChangePasswordOrder" "PasswordChangeCommand" "ChangePasswordTimer" "WarnOnPasswordExpiration" "PasswordExpirationMenu" "PasswordExpirationMenuDays" "ExpirationWarningDays" "ADExpirationShow" "PasswordPolicy" "ExportableKey" "X509CA" "Template" "WifiNetworks" "MenuIcon" "PFC_SegmentedControl_Menu" "ActionsUpdateTime" "GetHelpType" "GetHelpOptions" "SelfServicePath" "HideAbout" "HideActions" "HideChangePassword" "HideGetHelp" "HideGetSoftware" "HideLockScreen" "HidePreferences" "HideSignIn" "HideQuit" "MessagePasswordChangePolicy" "MenuAbout" "MenuActions" "MenuChangePassword" "MenuGetHelp" "MenuGetSoftware" "MenuLockScreen" "MenuPreferences" "MenuSignIn" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-menu-nomad-NoMADPro" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "NoMAD Pro (menu.nomad.NoMADPro) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}