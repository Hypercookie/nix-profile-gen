  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "TermsAccepted1809" "OfficeActivationEmailAddress" "OfficeAutoSignIn" "ConnectedOfficeExperiencesPreference" "OfficeExperiencesAnalyzingContentPreference" "OfficeExperiencesDownloadingContentPreference" "OptionalConnectedExperiencesPreference" "DiagnosticDataTypePreference" "SendAllTelemetryEnabled" "HasUserSeenEnterpriseFREDialog" "msoridEnableLogging" "msoridDefaultMinimumSeverity" "DefaultsToLocalOpenSave" "ShowDocStageOnLaunch" "ShowWhatsNewOnLaunch" "kCUIThemePreferencesThemeKeyPath" "InstallAutoUpdate" "InstallDefender" "InstallExcel" "InstallOneDrive" "InstallOneNote" "InstallOutlook" "InstallPowerPoint" "InstallTeams" "InstallWord" "VisualBasicEntirelyDisabled" "VisualBasicMacroExecutionState" "DisableVisualBasicExternalDylibs" "AllowVisualBasicToBindToSystem" "DisableVisualBasicToBindToPopen" "DisableVisualBasicMacScript" "VBAObjectModelIsTrusted" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-microsoft-office" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Microsoft Office (com.microsoft.office) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}