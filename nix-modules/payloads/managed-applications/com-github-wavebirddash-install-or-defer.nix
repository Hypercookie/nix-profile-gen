...
in
{
  options.programs.macprofile.payloads."managed-applications-com-github-wavebirddash-install-or-defer" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Install or Defer (com.github.wavebirddash.install-or-defer) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}