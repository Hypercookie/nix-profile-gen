  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "DontShowAdditionalContentDowload" "FeatureAvailable_ExpertAudio" "FeatureAvailable_ExpertCS" "FeatureAvailable_ExpertEditing" "FeatureAvailable_ExpertMIDI" "FeatureAvailable_ExpertScore" "FeatureAvailable_Surround" "userLevel" "startupAction" "RecentWhatsNewPanelVersion" "QuickHelpMode" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-apple-logic10" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Logic Pro X (com.apple.logic10) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}