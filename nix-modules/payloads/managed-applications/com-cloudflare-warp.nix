  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "display_name" "organization" "gateway_unique_id" "service_mode" "onboarding" "switch_locked" "auto_connect" "support_url" "override_api_endpoint" "override_doh_endpoint" "override_warp_endpoint" "unique_client_id" "auth_client_id" "auth_client_secret" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-cloudflare-warp" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Cloudflare WARP Client (com.cloudflare.warp) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}