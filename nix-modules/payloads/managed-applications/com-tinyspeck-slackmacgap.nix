  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "ClientEnvironment" "HardwareAcceleration" "DownloadPath" "DefaultSignInTeam" "ReleaseChannel" "AutoUpdate" "Defaults" "SlackNoAutoUpdates" "SlackDefaultSignInWorkspace" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-tinyspeck-slackmacgap" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Slack (com.tinyspeck.slackmacgap) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}