...
in
{
  options.programs.macprofile.payloads."managed-applications-com-google-Keystone" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Google Software Updates (com.google.Keystone) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}