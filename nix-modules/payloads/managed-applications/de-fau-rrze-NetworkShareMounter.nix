  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "autostart" "canChangeAutostart" "enableAutoUpdater" "helpURL" "unmountOnExit" "useNewDefaultLocation" "location" "cleanupLocationDirectory" "canQuit" "kerberosRealm" "managedNetworkShares" "networkShares" ];
