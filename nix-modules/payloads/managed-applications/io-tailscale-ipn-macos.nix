  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "ManagedByOrganizationName" "ManagedByCaption" "ManagedByURL" "TailscaleStartOnLogin" "ForceEnabled" "HideDHCP121Warnings" "Tailnet" "LoginURL" "ExitNodeID" "KeyExpirationNotice" "ExitNodeAllowLANAccess" "UseTailscaleSubnets" "Hostname" "UseTailscaleDNSSettings" "AllowIncomingConnections" "PostureChecking" "ExitNodesPicker" "ManageTailnetLock" "ResetToDefaults" "RunExitNode" "StartOnLoginMenuItem" "TestMenu" "UpdateMenu" "HiddenNetworkDevices" "IPAddressCopiedAlertSuppressed" "CLIIntegration" "TailscaleOnboardingSeen" "VPNOnDemandSettings" ];
