  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "labMode" "showOnDesktop" "showMenuBarExtra" "detailLevel" "preferredDisplay" "desktopPosition" "desktopMargin" "desktopTopMargin" "desktopBottomMargin" "desktopLeftMargin" "desktopRightMargin" "textTheme" "lightDarkText" "textSize" "dropShadow" "labelCase" "menuBarWidgetAppearance" "menuBarWidgetTextSize" "detachableMenuBarWidget" "menuBarIcon" "allNetworkInterfaces" "dhcpLeaseRemaining" "macAddressFormat" "networkDetailLevel" "networkNotifications" "subnetMaskCIDRNotation" "explicitNoNetworkConfiguration" "appStoreVersionCheck" "coreCount" "dateFormat" "disableCrashManager" "diskFreeSpace" "diskFreeSpaceNonBootVolumes" "firstRunDone" "headerText" "footerText" "hideDockIcon" "ignoreHiding" "operatingSystemVersionName" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-net-glencode-Particulars" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Particulars (net.glencode.Particulars) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}