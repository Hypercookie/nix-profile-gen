# Auto-generated from ProfileManifests: com.brave.Browser.plist
  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "CloudReportingEnabled" "CloudExtensionRequestEnabled" "ReportSafeBrowsingData" "DefaultClipboardSetting" "DefaultCookiesSetting" "BlockThirdPartyCookies" "CookiesAllowedForUrls" "CookiesBlockedForUrls" "CookiesSessionOnlyForUrls" "DefaultWebBluetoothGuardSetting" "DefaultWebUsbGuardSetting" "DefaultImagesSetting" "ImagesAllowedForUrls" "ImagesBlockedForUrls" "DefaultInsecureContentSetting" "InsecureContentAllowedForUrls" "InsecureContentBlockedForUrls" "DefaultJavaScriptSetting" "JavaScriptAllowedForUrls" "JavaScriptBlockedForUrls" "LegacySameSiteCookieBehaviorEnabled" "LegacySameSiteCookieBehaviorEnabledForDomainList" "DefaultPluginsSetting" "PluginsAllowedForUrls" "DefaultNotificationsSetting" "NotificationsAllowedForUrls" "NotificationsBlockedForUrls" "PdfLocalFileAccessAllowedForDomains" "PluginsBlockedForUrls" "DefaultPopupsSetting" "DefaultThirdPartyStoragePartitioningSetting" "PopupsAllowedForUrls" "PopupsBlockedForUrls" "AutoSelectCertificateForUrls" "DefaultGeolocationSetting" "DefaultMediaStreamSetting" "RegisteredProtocolHandlers" "ThirdPartyStoragePartitioningBlockedForOrigins" "WebUsbAllowDevicesForUrls" "AutoplayAllowed" "AutoplayWhitelist" "AutoplayAllowlist" "DefaultSearchProviderAlternateURLs" "DefaultSearchProviderEnabled" "DefaultSearchProviderEncodings" "DefaultSearchProviderIconURL" "DefaultSearchProviderImageURL" "DefaultSearchProviderImageURLPostParams" "DefaultSearchProviderKeyword" "DefaultSearchProviderName" "DefaultSearchProviderNewTabURL" "DefaultSearchProviderSearchURL" "DefaultSearchProviderSearchURLPostParams" "DefaultSearchProviderSuggestURL" "DefaultSearchProviderSuggestURLPostParams" "ExtensionAllowedTypes" "ExtensionInstallSources" "ExtensionInstallBlacklist" "ExtensionInstallBlocklist" "ExtensionInstallWhitelist" "ExtensionInstallAllowlist" "ExtensionManifestV2Availability" "ExtensionInstallForcelist" "ExtensionSettings" "BlockExternalExtensions" "ExtensionAllowInsecureUpdates" "EnableMediaRouter" "ShowCastIconInToolbar" "AllowCrossOriginAuthPrompt" "AuthNegotiateDelegateByKdcPolicy" "AuthNegotiateDelegateWhitelist" "AuthNegotiateDelegateAllowlist" "AuthSchemes" "AuthServerWhitelist" "BasicAuthOverHttpEnabled" "AuthServerAllowlist" "DisableAuthNegotiateCnameLookup" "EnableAuthNegotiatePort" "NtlmV2Enabled" "BrowserSwitcherEnabled" "AlternativeBrowserParameters" "AlternativeBrowserPath" "BrowserSwitcherDelay" "BrowserSwitcherKeepLastChromeTab" "BrowserSwitcherUrlList" "BrowserSwitcherUrlGreylist" "BrowserSwitcherExternalGreylistUrl" "BrowserSwitcherExternalSitelistUrl" "AbusiveExperienceInterventionEnforce" "AccessibilityImageLabelsEnabled" "AdsSettingForIntrusiveAdsSites" "LocalNetworkAccessRestrictionsEnabled" "LocalNetworkAccessAllowedForUrls" "LocalNetworkAccessBlockedForUrls" "PrivacySandboxAdMeasurementEnabled" "PrivacySandboxAdTopicsEnabled" "PrivacySandboxPromptEnabled" "PrivacySandboxSiteEnabledAdsEnabled" "AdvancedProtectionAllowed" "AdvancedProtectionDeepScanningEnabled" "AllowDeletingBrowserHistory" "AllowDinosaurEasterEgg" "AllowFileSelectionDialogs" "AllowOutdatedPlugins" "AllowPopupsDuringPageUnload" "AllowSyncXHRInPageDismissal" "AllowWebAuthnWithBrokenTlsCerts" "AllowedDomainsForApps" "AlternateErrorPagesEnabled" "AlwaysOpenPdfExternally" "AmbientAuthenticationInPrivateModesEnabled" "AppCacheForceEnabled" "AudioCaptureAllowed" "AudioSandboxEnabled" "AudioCaptureAllowedUrls" "AutoFillEnabled" "AutoLaunchProtocolsFromOrigins" "AutoOpenAllowedForURLs" "AutoOpenFileTypes" "AutofillAddressEnabled" "AutofillCreditCardEnabled" "BookmarkBarEnabled" "BrowserAddPersonEnabled" "BrowserGuestModeEnabled" "BrowserGuestModeEnforced" "BrowserNetworkTimeQueriesEnabled" "BrowserSignin" "BuiltInDnsClientEnabled" "BuiltinCertificateVerifierEnabled" "CertificateTransparencyEnforcementDisabledForCas" "CertificateTransparencyEnforcementDisabledForLegacyCas" "CertificateTransparencyEnforcementDisabledForUrls" "ChromeVariations" "ClickToCallEnabled" "CloudManagementEnrollmentToken" "CloudManagementEnrollmentMandatory" "CloudPolicyOverridesPlatformPolicy" "CommandLineFlagSecurityWarningsEnabled" "ComponentUpdatesEnabled" "CorsLegacyModeEnabled" "CorsMitigationList" "DNSInterceptionChecksEnabled" "DefaultBrowserSettingEnabled" "PromotionsEnabled" "DefaultDownloadDirectory" "DefaultSearchProviderContextMenuAccessAllowed" "DeveloperToolsAvailability" "Disable3DAPIs" "DisableSafeBrowsingProceedAnyway" "DisableScreenshots" "DisabledPlugins" "DisabledPluginsExceptions" "DisabledSchemes" "DiskCacheDir" "DiskCacheSize" "DnsOverHttpsMode" "DnsOverHttpsTemplates" "DomainReliabilityAllowed" "DownloadDirectory" "DownloadRestrictions" "EditBookmarksEnabled" "EnableDeprecatedWebPlatformFeatures" "EnableExperimentalPolicies" "EnableOnlineRevocationChecks" "EnabledPlugins" "EncryptedClientHelloEnabled" "EnterpriseHardwarePlatformAPIEnabled" "EnterpriseProfileCreationKeepBrowsingData" "EnterpriseRealTimeUrlCheckMode" "ExternalProtocolDialogShowAlwaysOpenCheckbox" "FileOrDirectoryPickerWithoutGestureAllowedForOrigins" "ForceBrowserSignin" "ForceEphemeralProfiles" "ForceGoogleSafeSearch" "ForceSafeSearch" "ForceLegacyDefaultReferrerPolicy" "GloballyScopeHTTPAuthCacheEnabled" "GoogleSearchSidePanelEnabled" "ForceYouTubeRestrict" "ForceYouTubeSafetyMode" "HardwareAccelerationModeEnabled" "HideWebStoreIcon" "HSTSPolicyBypassList" "Http09OnNonDefaultPortsEnabled" "HttpsUpgradesEnabled" "ImportAutofillFormData" "ImportBookmarks" "ImportHistory" "ImportHomepage" "ImportSavedPasswords" "ImportSearchEngine" "IncognitoEnabled" "IncognitoModeAvailability" "IntensiveWakeUpThrottlingEnabled" "IsolateOrigins" "JavascriptEnabled" "LocalDiscoveryEnabled" "LookalikeWarningAllowlistDomains" "MachineLevelUserCloudPolicyEnrollmentToken" "ManagedBookmarks" "MaxConnectionsPerProxy" "MaxInvalidationFetchDelay" "MediaRecommendationsEnabled" "MediaRouterCastAllowAllIPs" "MetricsReportingEnabled" "NetworkPredictionOptions" "NTPCardsVisible" "NTPCustomBackgroundEnabled" "OverrideSecurityRestrictionsOnInsecureOrigin" "PaymentMethodQueryEnabled" "PolicyAtomicGroupsEnabled" "PolicyDictionaryMultipleSourceMergeList" "PolicyListMultipleSourceMergeList" "PolicyRefreshRate" "ProfilePickerOnStartupAvailability" "PromotionalTabsEnabled" "PromptForDownloadLocation" "QuicAllowed" "RelaunchNotification" "RelaunchNotificationPeriod" "RemoteDebuggingAllowed" "RestrictSigninToPattern" "RunAllFlashInAllowMode" "SafeBrowsingForTrustedSourcesEnabled" "SafeSitesFilterBehavior" "SavingBrowserHistoryDisabled" "ScreenCaptureAllowed" "ScrollToTextFragmentEnabled" "SearchSuggestEnabled" "SecurityKeyPermitAttestation" "SharedClipboardEnabled" "ShowAppsShortcutInBookmarkBar" "ShowFullUrlsInAddressBar" "SignedHTTPExchangeEnabled" "SigninAllowed" "SigninInterceptionEnabled" "SitePerProcess" "SpellCheckServiceEnabled" "SpellcheckEnabled" "SSLErrorOverrideAllowed" "SSLVersionMin" "StrictMimetypeCheckForWorkerScriptsEnabled" "StricterMixedContentTreatmentEnabled" "SuppressUnsupportedOSWarning" "SyncDisabled" "SyncTypesListDisabled" "TargetBlankImpliesNoOpener" "TaskManagerEndProcessEnabled" "TLS13HardeningForLocalAnchorsEnabled" "TotalMemoryLimitMb" "TranslateEnabled" "URLBlacklist" "URLBlocklist" "URLWhitelist" "URLAllowlist" "UnsafelyTreatInsecureOriginAsSecure" "UrlKeyedAnonymizedDataCollectionEnabled" "UserAgentClientHintsEnabled" "UserFeedbackAllowed" "UserDataDir" "UserDataSnapshotRetentionLimit" "VideoCaptureAllowed" "VideoCaptureAllowedUrls" "WebAppInstallForceList" "WebComponentsV0Enabled" "WebDriverOverridesIncompatiblePolicies" "WebRtcAllowLegacyTLSProtocols" "WebRtcEventLogCollectionAllowed" "WebRtcLocalIpsAllowedUrls" "WebRtcUdpPortRange" "WPADQuickCheckEnabled" "NativeMessagingBlacklist" "NativeMessagingBlocklist" "NativeMessagingUserLevelHosts" "NativeMessagingWhitelist" "NativeMessagingAllowlist" "PasswordLeakDetectionEnabled" "PasswordManagerEnabled" "CloudPrintProxyEnabled" "CloudPrintSubmitEnabled" "DefaultPrinterSelection" "DisablePrintPreview" "PrintHeaderFooter" "PrinterTypeDenyList" "PrintingAllowedBackgroundGraphicsModes" "PrintingBackgroundGraphicsDefault" "PrintingEnabled" "PrintPreviewUseSystemDefaultPrinter" "PrinterPaperSizeDefault" "ProxyBypassList" "ProxySettings" "ProxyMode" "ProxyPacUrl" "ProxyServer" "ProxyServerMode" "RemoteAccessHostAllowClientPairing" "RemoteAccessHostAllowFileTransfer" "RemoteAccessHostAllowGnubbyAuth" "RemoteAccessHostAllowRelayedConnection" "RemoteAccessHostClientDomain" "RemoteAccessHostClientDomainList" "RemoteAccessHostDomain" "RemoteAccessHostDomainList" "RemoteAccessHostFirewallTraversal" "RemoteAccessHostMatchUsername" "RemoteAccessHostRequireCurtain" "RemoteAccessHostTalkGadgetPrefix" "RemoteAccessHostTokenUrl" "RemoteAccessHostTokenValidationCertificateIssuer" "RemoteAccessHostTokenValidationUrl" "RemoteAccessHostUdpPortRange" "PasswordProtectionChangePasswordURL" "PasswordProtectionLoginURLs" "PasswordProtectionWarningTrigger" "SafeBrowsingEnabled" "SafeBrowsingExtendedReportingEnabled" "SafeBrowsingProtectionLevel" "SafeBrowsingWhitelistDomains" "SafeBrowsingAllowlistDomains" "SafeBrowsingExtendedReportingOptInAllowed" "HomepageIsNewTabPage" "HomepageLocation" "NewTabPageLocation" "RestoreOnStartup" "RestoreOnStartupURLs" "ShowHomeButton" "WebUsbAskForUrls" "WebUsbBlockedForUrls" "DeveloperToolsDisabled" "TorDisabled" "IPFSEnabled" "BraveRewardsDisabled" "BraveWalletDisabled" "BraveShieldsDisabledForUrls" "BraveShieldsEnabledForUrls" "BraveVPNDisabled" "BraveAIChatEnabled" "SUFeedURL" "SUEnableAutomaticChecks" "SUScheduledCheckInterval" "SUAllowsAutomaticUpdates" "SUAutomaticallyUpdate" ];
      ...
      DefaultClipboardSetting = lib.mkOption {
        ...
        default = null;
        description = "This policy only affects clipboard operations controlled by the clipboard site permission, and does not affect sanitized clipboard writes or trusted copy and paste operations.";
      };
      ...
      PdfLocalFileAccessAllowedForDomains = lib.mkOption {
        type = types.nullOr (types.listOf (types.str));
        default = null;
        description = "Setting this policy allows the domains listed to access file:// URLs in the PDF Viewer.";
      };
              ...
              type = types.nullOr (types.submodule {
                options = {
                  ...
                  ExtensionUnpublishedAvailability = lib.mkOption {
                    ...
                    default = null;
                    description = "If this policy is enabled, extensions that are unpublished on the Chrome Web Store will be disabled in Brave Browser";
                  };
      ...
      AllowWebAuthnWithBrokenTlsCerts = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy will allow WebAuthn on sites with invalid TLS certificates.";
      };
      ...
      PromotionsEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "Setting the policy to True or leaving it unset lets Brave Browser show users product promotional content.";
      };
      ...
      DomainReliabilityAllowed = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy will allow sending domain reliability data to Google";
      };
      ...
      EncryptedClientHelloEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy will allow encryption of TLS ClientHello for enhanced privacy.";
      };
      ...
      EnterpriseProfileCreationKeepBrowsingData = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy will allow keeping browsing data in new enterprise profiles";
      };
      ...
      FileOrDirectoryPickerWithoutGestureAllowedForOrigins = lib.mkOption {
        type = types.nullOr (types.listOf (types.str));
        default = null;
        description = "This policy will allow file picker APIs without user gesture for specified origins";
      };
      ...
      GoogleSearchSidePanelEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy will allow Google Search Side Panel.";
      };
      ...
      HttpsUpgradesEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy will allow automatic HTTPS upgrades.";
      };
      ...
      SafeBrowsingForTrustedSourcesEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "Setting the policy to Enabled or leaving it unset means downloaded files are sent to be analyzed by Safe Browsing, even when it's from a trusted source.\nSetting the policy to Disabled means downloaded files won't be sent to be analyzed by Safe Browsing when it's from a trusted source.";
      };
      ...
      StrictMimetypeCheckForWorkerScriptsEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "This policy enables strict MIME type checking for worker scripts.";
      };
      ...
      TorDisabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "If 'true', Tor is disabled.";
      };

      IPFSEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "If 'false', IPFS is disabled.";
      };

      BraveRewardsDisabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "If 'true', Brave Rewards are disabled.";
      };

      BraveWalletDisabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "If 'true', Brave Wallet is disabled.";
      };

      BraveShieldsDisabledForUrls = lib.mkOption {
        type = types.nullOr (types.listOf (types.str));
        default = null;
      ...
      BraveShieldsEnabledForUrls = lib.mkOption {
        type = types.nullOr (types.listOf (types.str));
        default = null;
        description = "Array of websites (each as a string) for which you want to enable Brave shields. Once enabled, the user can’t override and disable. Wildcards are not supported.";
      };

      BraveVPNDisabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "If 'true', Brave VPN is disabled.";
      };

      BraveAIChatEnabled = lib.mkOption {
        type = types.nullOr (types.bool);
        default = null;
        description = "If 'false', Brave AI Chat is disabled.";
      };
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-brave-Browser" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Brave Browser (com.brave.Browser) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}