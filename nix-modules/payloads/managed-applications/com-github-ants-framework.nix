  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "main" "ad" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-github-ants-framework" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "ANTS Framework (com.github.ants-framework) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}