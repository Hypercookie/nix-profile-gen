  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "startupWhatToDo" "UpdatePkginfosOnSave" "UpdateManifestsOnSave" "UpdateCatalogsOnSave" "makecatalogsForceEnabled" "makecatalogsSkipPkgCheck" "makecatalogsOnlyIfNeeded" "MoveInstallerItemsWithPkginfos" "sidebarDirectoriesVisible" "sidebarInstallerTypesVisible" "sidebarCategoriesVisible" "sidebarDevelopersVisible" "sidebarDeveloperMinimumNumberOfPackageNames" "makepkginfoPath" "makecatalogsPath" "sortManagedInstallsByTitle" "sortManagedUninstallsByTitle" "sortManagedUpdatesByTitle" "sortOptionalInstallsByTitle" "sortFeaturedItemsByTitle" "sortPkginfoCatalogsByTitle" "CopyPkgsToRepo" "items_to_copyUseDefaults" "items_to_copyOwner" "items_to_copyGroup" "items_to_copyMode" "assimilate_enabled" "assimilate_autoremove" "assimilate_blocking_applications" "assimilate_category" "assimilate_description" "assimilate_developer" "assimilate_display_name" "assimilate_icon_hash" "assimilate_icon_name" "assimilate_installable_condition" "assimilate_installcheck_script" "assimilate_installer_choices_xml" "assimilate_installs_items" "assimilate_items_to_copy" "assimilate_maximum_os_version" "assimilate_minimum_munki_version" "assimilate_minimum_os_version" "assimilate_name" "assimilate_pre_scripts" "assimilate_preinstall_script" "assimilate_postinstall_script" "assimilate_preuninstall_script" "assimilate_postuninstall_script" "assimilate_post_scripts" "assimilate_receipts" "assimilate_requires" "assimilate_supported_architectures" "assimilate_unattended_install" "assimilate_unattended_uninstall" "assimilate_uninstall_method" "assimilate_uninstall_script" "assimilate_uninstallable" "assimilate_uninstallcheck_script" "assimilate_uninstaller_item_location" "assimilate_update_for" "logLevel" "logToFile" "logToSyslog" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-hjuutilainen-MunkiAdmin" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "MunkiAdmin (com.hjuutilainen.MunkiAdmin) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}