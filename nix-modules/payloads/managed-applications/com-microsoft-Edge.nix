  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "DefaultCookiesSetting" "BlockThirdPartyCookies" "CookiesAllowedForUrls" "CookiesBlockedForUrls" "CookiesSessionOnlyForUrls" "DefaultImagesSetting" "DefaultInsecureContentSetting" "InsecureContentAllowedForUrls" "InsecureContentBlockedForUrls" "DefaultJavaScriptSetting" "DefaultPluginsSetting" "DefaultPopupsSetting" "DefaultWebBluetoothGuardSetting" "DefaultWebUsbGuardSetting" "ImagesAllowedForUrls" "ImagesBlockedForUrls" "JavaScriptAllowedForUrls" "JavaScriptBlockedForUrls" "LegacySameSiteCookieBehaviorEnabled" "LegacySameSiteCookieBehaviorEnabledForDomainList" "PluginsAllowedForUrls" "PluginsBlockedForUrls" "DefaultThirdPartyStoragePartitioningSetting" "ThirdPartyStoragePartitioningBlockedForOrigins" "PopupsAllowedForUrls" "PopupsBlockedForUrls" "AutoSelectCertificateForUrls" "DefaultGeolocationSetting" "RegisteredProtocolHandlers" "WebUsbAllowDevicesForUrls" "AutoplayAllowed" "BackgroundModeEnabled" "BackgroundTemplateListUpdatesEnabled" "BingAdsSuppression" "DefaultNotificationsSetting" "NotificationsAllowedForUrls" "NotificationsBlockedForUrls" "DefaultSearchProviderEnabled" "DefaultSearchProviderEncodings" "DefaultSearchProviderImageURL" "DefaultSearchProviderImageURLPostParams" "DefaultSearchProviderKeyword" "DefaultSearchProviderName" "DefaultSearchProviderSearchURL" "DefaultSearchProviderSuggestURL" "BlockExternalExtensions" "ExtensionAllowedTypes" "ExtensionInstallSources" "ExtensionInstallBlocklist" "ExtensionInstallAllowlist" "ExtensionInstallForcelist" "ExtensionSettings" "EnableMediaRouter" "ShowCastIconInToolbar" "AllowCrossOriginAuthPrompt" "AuthNegotiateDelegateAllowlist" "AuthSchemes" "AuthServerAllowlist" "DisableAuthNegotiateCnameLookup" "EnableAuthNegotiatePort" "NtlmV2Enabled" "AdsSettingForIntrusiveAdsSites" "AllowDeletingBrowserHistory" "AllowFileSelectionDialogs" "AllowPopupsDuringPageUnload" "AllowSurfGame" "AllowSyncXHRInPageDismissal" "AllowTrackingForUrls" "AlternateErrorPagesEnabled" "AlwaysOpenPdfExternally" "AppCacheForceEnabled" "ApplicationLocaleValue" "AudioCaptureAllowed" "AudioCaptureAllowedUrls" "AutoImportAtFirstRun" "AutoOpenAllowedForURLs" "AutoOpenFileTypes" "AutofillAddressEnabled" "AutofillCreditCardEnabled" "FavoritesBarEnabled" "BrowserAddProfileEnabled" "BrowserGuestModeEnabled" "BrowserNetworkTimeQueriesEnabled" "BrowserSignin" "BuiltinCertificateVerifierEnabled" "BuiltInDnsClientEnabled" "DnsOverHttpsMode" "DnsOverHttpsTemplates" "CertificateTransparencyEnforcementDisabledForCas" "CertificateTransparencyEnforcementDisabledForLegacyCas" "CertificateTransparencyEnforcementDisabledForUrls" "ClearBrowsingDataOnExit" "ClearCachedImagesAndFilesOnExit" "CollectionsServicesAndExportsBlockList" "CommandLineFlagSecurityWarningsEnabled" "ComponentUpdatesEnabled" "ConfigureDoNotTrack" "ConfigureOnlineTextToSpeech" "CustomHelpLink" "DNSInterceptionChecksEnabled" "DefaultBrowserSettingEnabled" "DefaultSearchProviderContextMenuAccessAllowed" "DeveloperToolsAvailability" "DiagnosticData" "Disable3DAPIs" "DisableScreenshots" "DiskCacheDir" "DiskCacheSize" "DownloadDirectory" "DownloadRestrictions" "EdgeCollectionsEnabled" "EditFavoritesEnabled" "EnableDeprecatedWebPlatformFeatures" "EnableDomainActionsDownload" "EnableOnlineRevocationChecks" "EnableSha1ForLocalAnchors" "EnterpriseHardwarePlatformAPIEnabled" "ExperimentationAndConfigurationServiceControl" "ExternalProtocolDialogShowAlwaysOpenCheckbox" "ForceEphemeralProfiles" "ForceBingSafeSearch" "ForceCertificatePromptsOnMultipleMatches" "ForceGoogleSafeSearch" "ForceLegacyDefaultReferrerPolicy" "ForceYouTubeRestrict" "FullscreenAllowed" "GoToIntranetSiteForSingleWordEntryInAddressBar" "HSTSPolicyBypassList" "HardwareAccelerationModeEnabled" "HideFirstRunExperience" "HubsSidebarEnabled" "ImportAutofillFormData" "ImportBrowserSettings" "ImportCookies" "ImportExtensions" "ImportFavorites" "ImportHistory" "ImportHomepage" "ImportOpenTabs" "ImportPaymentInfo" "ImportSavedPasswords" "ImportSearchEngine" "ImportShortcuts" "InPrivateModeAvailability" "IsolateOrigins" "ManagedFavorites" "ManagedSearchEngines" "NewTabPageSearchBox" "MaxConnectionsPerProxy" "MediaRouterCastAllowAllIPs" "MetricsReportingEnabled" "MicrosoftEdgeInsiderPromotionEnabled" "OmniboxMSBProviderEnabled" "PaymentMethodQueryEnabled" "PersonalizationReportingEnabled" "ProactiveAuthEnabled" "NetworkPredictionOptions" "OverrideSecurityRestrictionsOnInsecureOrigin" "PolicyRefreshRate" "PromotionalTabsEnabled" "PromptForDownloadLocation" "ProxySettings" "QuicAllowed" "RelaunchNotification" "RelaunchNotificationPeriod" "ResolveNavigationErrorsUseWebService" "RestrictSigninToPattern" "RunAllFlashInAllowMode" "SSLErrorOverrideAllowed" "SSLVersionMin" "SaveCookiesOnExit" "SavingBrowserHistoryDisabled" "SearchSuggestEnabled" "SecurityKeyPermitAttestation" "SendSiteInfoToImproveServices" "ShowOfficeShortcutInFavoritesBar" "SignedHTTPExchangeEnabled" "SitePerProcess" "SpellcheckEnabled" "StricterMixedContentTreatmentEnabled" "SuppressUnsupportedOSWarning" "SyncDisabled" "SyncTypesListDisabled" "TLS13HardeningForLocalAnchorsEnabled" "TLSCipherSuiteDenyList" "TabFreezingEnabled" "TaskManagerEndProcessEnabled" "TotalMemoryLimitMb" "TrackingPrevention" "TyposquattingCheckerEnabled" "TranslateEnabled" "URLBlocklist" "UserAgentClientHintsEnabled" "URLAllowlist" "UserFeedbackAllowed" "UserDataDir" "VideoCaptureAllowed" "VideoCaptureAllowedUrls" "WPADQuickCheckEnabled" "WebAppInstallForceList" "WebComponentsV0Enabled" "WebDriverOverridesIncompatiblePolicies" "WebRtcLocalIpsAllowedUrls" "WebRtcLocalhostIpHandling" "WebRtcUdpPortRange" "NativeMessagingBlocklist" "NativeMessagingUserLevelHosts" "NativeMessagingAllowlist" "PasswordManagerEnabled" "PasswordMonitorAllowed" "DefaultPrinterSelection" "PrintHeaderFooter" "PrintingEnabled" "UseSystemPrintDialog" "PrintPreviewUseSystemDefaultPrinter" "ProxyBypassList" "ProxyMode" "ProxyPacUrl" "ProxyServer" "SmartScreenEnabled" "PreventSmartScreenPromptOverride" "PreventSmartScreenPromptOverrideForFiles" "SmartScreenAllowListDomains" "SmartScreenForTrustedDownloadsEnabled" "SmartScreenPuaEnabled" "PasswordProtectionChangePasswordURL" "PasswordProtectionLoginURLs" "PasswordProtectionWarningTrigger" "HomepageIsNewTabPage" "HomepageLocation" "NewTabPageAllowedBackgroundTypes" "NewTabPageCompanyLogo" "NewTabPageContentEnabled" "NewTabPageHideDefaultTopSites" "NewTabPageLocation" "NewTabPageManagedQuickLinks" "NewTabPageSetFeedType" "RestoreOnStartup" "RestoreOnStartupURLs" "ShowHomeButton" "WebUsbAskForUrls" "WebUsbBlockedForUrls" "AutoLaunchProtocolsFromOrigins" "AutoLaunchProtocolsComponentEnabled" "LocalNetworkAccessRestrictionsEnabled" "LocalNetworkAccessAllowedForUrls" "LocalNetworkAccessBlockedForUrls" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-microsoft-Edge" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Microsoft Edge (com.microsoft.Edge) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}