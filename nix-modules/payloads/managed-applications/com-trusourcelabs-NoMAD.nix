  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "ADDomain" "PFC_SegmentedControl_0" "LDAPType" "LDAPOverSSL" "LDAPAnonymous" "LDAPOnly" "LDAPServerList" "CustomLDAPAttributes" "HomeAppendDomain" "RecursiveGroupLookup" "KerberosRealm" "RenewTickets" "SecondsToRenew" "UserSwitch" "DontMatchKerbPrefs" "ConfigureChrome" "ConfigureChromeDomain" "UseKeychain" "LocalPasswordSync" "LocalPasswordSyncOnMatchOnly" "LocalPasswordSyncDontSyncLocalUsers" "LocalPasswordSyncDontSyncNetworkUsers" "KeychainItems" "KeychainItemsDebug" "HicFix" "PFC_SegmentedControl_Password" "PasswordPolicy" "ChangePasswordCommand" "ChangePasswordType" "ChangePasswordOptions" "HideExpiration" "HideExpirationMessage" "PasswordExpireAlertTime" "PasswordExpireCustomAlert" "PasswordExpireCustomWarnTime" "PasswordExpireCustomAlertTime" "UPCAlert" "MessageUPCAlert" "UPCAlertAction" "GetCertificateAutomatically" "AutoRenewCert" "ExportableKey" "CleanCerts" "X509CA" "Template" "WifiNetworks" "LightsOutIKnowWhatImDoing" "PFC_SegmentedControl_Menu" "MountSharesWithFinder" "GetHelpType" "GetHelpOptions" "SelfServicePath" "HideAbout" "HideGetSoftware" "HideHelp" "ShowHome" "HideLockScreen" "HidePrefs" "HideQuit" "HideRenew" "HideSignOut" "PersistExpiration" "MessageNotConnected" "MessagePasswordChangePolicy" "MessageLocalSync" "MenuAbout" "MenuChangePassword" "MenuFileServers" "MenuGetCertificate" "MenuGetSoftware" "MenuGetHelp" "MenuHomeDirectory" "MenuRenewTickets" "MenuUserName" "MenuPasswordExpires" "CaribouTime" "IconOn" "IconOff" "IconOnDark" "IconOffDark" "Verbose" "LoginItem" "SignInCommand" "SignOutCommand" "StateChangeAction" "AutoConfigure" "PFC_SegmentedControl_General" "DontShowWelcome" "DontShowWelcomeDefaultOn" "MenuWelcome" "SignInWindowOnLaunch" "UseKeychainPrompt" "SignInWindowAlert" "SignInWindowAlertTime" "TitleSignIn" "SignInWindowOnLaunchExclusions" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-trusourcelabs-NoMAD" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "NoMAD (com.trusourcelabs.NoMAD) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}