# Auto-generated from ProfileManifests: com.microsoft.Powerpoint.plist
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "Microsoft PowerPoint";

      _domain = lib.mkOption {
        internal = true;
        type = lib.types.str;
        default = "com.microsoft.Powerpoint";
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-microsoft-Powerpoint" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Microsoft PowerPoint (com.microsoft.Powerpoint) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}