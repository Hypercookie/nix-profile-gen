  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "ServerURL" "RemovePlist" "RotateUsedKey" "ValidateKey" "OutputPath" "KeyEscrowInterval" "SkipUsers" "PostRunCommand" ];
...
in
{
  options.programs.macprofile.payloads."managed-applications-com-grahamgilbert-crypt" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Crypt (com.grahamgilbert.crypt) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}