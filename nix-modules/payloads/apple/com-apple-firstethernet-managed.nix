# Auto-generated from ProfileManifests: com.apple.firstethernet.managed.plist
# Domain: com.apple.firstethernet.managed
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "802.1X Ethernet: First";

      _domain = lib.mkOption {
        internal = true;
        type = lib.types.str;
        default = "com.apple.firstethernet.managed";
      ...
      Interface = lib.mkOption {
        type = types.nullOr (types.enum [ "FirstEthernet" ]);
        default = null;
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-firstethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: First (com.apple.firstethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}