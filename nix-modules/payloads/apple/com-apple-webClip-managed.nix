  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "Label" "URL" "IsRemovable" "Icon" "Precomposed" "FullScreen" "IgnoreManifestScope" "TargetApplicationBundleIdentifier" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-webClip-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Web Clip (com.apple.webClip.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}