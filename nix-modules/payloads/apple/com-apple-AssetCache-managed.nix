  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "AutoActivation" "CacheLimit" "AllowPersonalCaching" "PersonalCacheLimit" "AllowSharedCaching" "AutoEnableTetheredCaching" "Port" "DataPath" "DenyTetheredCaching" "LogClientIdentity" "Parents" "ParentSelectionPolicy" "PublicRanges" "AllowCacheDelete" "DisplayAlerts" "KeepAwake" "AgeForLowSpaceAlert" "AllowImports" "AllowWirelessPortable" "DatabaseUpdateInterval" "DownloadMinRate" "DownloadTimeout" "ImportMaxRate" "ImportMinRate" "ImportRateAttenuation" "ImportTimeout" "Interface" "ListenWithPeersAndParents" "MaxParentDepth" "MaxPeersToQuery" "MetricsInterval" "MetricsMaxAge" "OriginDownloadTimeout" "OriginUploadTimeout" "ParentDownloadTimeout" "ParentUploadTimeout" "ParentRetryInterval" "PruneAffinitiesAge" "PruneAffinitiesInterval" "PruneAssetsAge" "PruneAssetsInterval" "ReservedVolumeSpace" "TerminationTimeout" "Verbose" "PFC_SegmentedControl_0" "LocalSubnetsOnly" "ListenRangesOnly" "ListenRanges" "MaxConcurrentClients" "PeerLocalSubnetsOnly" "PeerFilterRanges" "PeerListenRanges" "PeerDownloadTimeout" "PeerNotifyTimeout" "PeerQueryTimeout" "PeerRetryInterval" ];
