  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "HostName" "UserName" "Password" "ClientID" "ADOrganizationalUnit" "ADCreateMobileAccountAtLoginFlag" "ADCreateMobileAccountAtLogin" "ADWarnUserBeforeCreatingMAFlag" "ADWarnUserBeforeCreatingMA" "ADForceHomeLocalFlag" "ADForceHomeLocal" "ADUseWindowsUNCPathFlag" "ADUseWindowsUNCPath" "ADMountStyle" "ADDefaultUserShellFlag" "ADDefaultUserShell" "ADMapUIDAttributeFlag" "ADMapUIDAttribute" "ADMapGIDAttributeFlag" "ADMapGIDAttribute" "ADMapGGIDAttributeFlag" "ADMapGGIDAttribute" "ADPreferredDCServerFlag" "ADPreferredDCServer" "ADDomainAdminGroupListFlag" "ADDomainAdminGroupList" "ADAllowMultiDomainAuthFlag" "ADAllowMultiDomainAuth" "ADNamespaceFlag" "ADNamespace" "ADPacketSignFlag" "ADPacketSign" "ADPacketEncryptFlag" "ADPacketEncrypt" "ADRestrictDDNSFlag" "ADRestrictDDNS" "ADTrustChangePassIntervalDaysFlag" "ADTrustChangePassIntervalDays" "Description" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-DirectoryService-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Active Directory (com.apple.DirectoryService.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}