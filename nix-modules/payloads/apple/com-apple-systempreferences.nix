  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "DisabledSystemSettings" "EnabledPreferencePanes" "DisabledPreferencePanes" "HiddenPreferencePanes" "AttentionPrefBundleIDs" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-systempreferences" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "System Preferences (com.apple.systempreferences) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}