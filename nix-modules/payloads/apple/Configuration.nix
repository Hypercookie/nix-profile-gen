  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "RemovalDate" "DurationUntilRemoval" "ConsentText" "HasRemovalPasscode" "TargetDeviceType" ];
...
in
{
  options.programs.macprofile.payloads."apple-Configuration" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "General (Configuration) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}