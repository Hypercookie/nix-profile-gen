# Auto-generated from ProfileManifests: com.apple.firstactiveethernet.managed.plist
# Domain: com.apple.firstactiveethernet.managed
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "802.1X Ethernet: First Active";
      ...
      Interface = lib.mkOption {
        type = types.nullOr (types.enum [ "FirstActiveEthernet" ]);
        default = null;
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-firstactiveethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: First Active (com.apple.firstactiveethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}