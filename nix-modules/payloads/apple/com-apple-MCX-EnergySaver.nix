  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "com.apple.EnergySaver.desktop.ACPower" "PFC_SegmentedControl_Portable" "com.apple.EnergySaver.portable.BatteryPower" "com.apple.EnergySaver.portable.ACPower" "com.apple.EnergySaver.desktop.Schedule" "SleepDisabled" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-MCX-EnergySaver" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Energy Saver (com.apple.MCX) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}