# Auto-generated from ProfileManifests: com.apple.globalethernet.managed.plist
# Domain: com.apple.globalethernet.managed
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "802.1X Ethernet: Global";
      ...
      Interface = lib.mkOption {
        type = types.nullOr (types.enum [ "AnyEthernet" ]);
        default = null;
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-globalethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: Global (com.apple.globalethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}