  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "DNSSettings" "OnDemandRules" "ProhibitDisablement" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-dnsSettings-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "DNS Settings (com.apple.dnsSettings.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}