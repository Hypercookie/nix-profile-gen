# Auto-generated from ProfileManifests: com.apple.thirdethernet.managed.plist
# Domain: com.apple.thirdethernet.managed
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "802.1X Ethernet: Third";

      _domain = lib.mkOption {
        internal = true;
        type = lib.types.str;
        default = "com.apple.thirdethernet.managed";
      ...
      Interface = lib.mkOption {
        type = types.nullOr (types.enum [ "ThirdEthernet" ]);
        default = null;
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-thirdethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: Third (com.apple.thirdethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}