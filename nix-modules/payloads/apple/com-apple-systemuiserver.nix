  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "mount_controls" "unmount_controls" "logout_eject" "menuExtras" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-systemuiserver" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Allowed Media and Menu Bar Extras (com.apple.systemuiserver) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}