  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "Relays" "MatchDomains" "ExcludedDomains" "RelayUUID" "MatchFQDNs" "ExcludedFQDNs" "UIToggleEnabled" "AllowDNSFailover" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-relay-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Relay (com.apple.relay.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}