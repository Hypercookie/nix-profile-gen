  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "PFC_SegmentedControl_0" "allowDeviceNameModification" "forceAutomaticDateAndTime" "allowAutomaticScreenSaver" "allowCamera" "allowCloudPrivateRelay" "blockedAppBundleIDs" "blacklistedAppBundleIDs" "allowListedAppBundleIDs" "whitelistedAppBundleIDs" "forceAssistantProfanityFilter" "allowInAppPurchases" "ratingRegion" "ratingApps" "ratingMovies" "ratingTVShows" "allowExplicitContent" "allowBookstoreErotica" "allowAirPlayIncomingRequests" "forceAirPlayIncomingRequestsPairingPassword" "allowRemoteAppPairing" "allowPasswordProximityRequests" "forceDelayedSoftwareUpdates" "enforcedSoftwareUpdateDelay" "allowDeviceSleep" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-applicationaccess-tvOS" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Restrictions (tvOS) (com.apple.applicationaccess) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}