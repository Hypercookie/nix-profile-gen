...
in
{
  options.programs.macprofile.payloads."apple-com-apple-thirdactiveethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: Third Active (com.apple.thirdactiveethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}