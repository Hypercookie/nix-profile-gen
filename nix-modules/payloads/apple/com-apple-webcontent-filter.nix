  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "FilterType" "FilterGrade" "AutoFilterEnabled" "PermittedURLs" "FilterBrowsers" "AllowListBookmarks" "WhitelistedBookmarks" "DenyListURLs" "BlacklistedURLs" "UserDefinedName" "PluginBundleID" "ServerAddress" "UserName" "Password" "Organization" "FilterSockets" "FilterDataProviderBundleIdentifier" "FilterDataProviderDesignatedRequirement" "FilterPackets" "FilterPacketProviderBundleIdentifier" "FilterPacketProviderDesignatedRequirement" "VendorConfig" "ContentFilterUUID" "HideDenyListURLs" "FilterURLs" "URLFilterParameters" "SafariHistoryRetentionEnabled" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-webcontent-filter" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Web Content Filter (com.apple.webcontent-filter) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}