...
in
{
  options.programs.macprofile.payloads."apple-com-apple-dock" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Dock (com.apple.dock) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}