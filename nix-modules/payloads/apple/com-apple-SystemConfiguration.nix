...
in
{
  options.programs.macprofile.payloads."apple-com-apple-SystemConfiguration" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Proxies (com.apple.SystemConfiguration) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}