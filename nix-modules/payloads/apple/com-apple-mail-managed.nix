  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "EmailAccountType" "EmailAccountDescription" "IncomingMailServerIMAPPathPrefix" "EmailAccountName" "EmailAddress" "IdentificationUUID" "PreventMove" "disableMailRecentsSyncing" "allowMailDrop" "PreventAppSheet" "SMIMEEnabled" "SMIMESigningEnabled" "SMIMESigningCertificateUUID" "SMIMEEncryptionEnabled" "SMIMEEncryptionCertificateUUID" "SMIMEEnablePerMessageSwitch" "SMIMESigningUserOverrideable" "SMIMESigningCertificateUUIDUserOverrideable" "SMIMEEncryptByDefault" "SMIMEEncryptByDefaultUserOverrideable" "SMIMEEncryptionCertificateUUIDUserOverrideable" "SMIMEEnableEncryptionPerMessageSwitch" "PFC_SegmentedControl_0" "IncomingMailServerHostName" "IncomingMailServerPortNumber" "IncomingMailServerUsername" "IncomingMailServerAuthentication" "IncomingPassword" "IncomingMailServerUseSSL" "OutgoingMailServerHostName" "OutgoingMailServerPortNumber" "OutgoingMailServerUsername" "OutgoingMailServerAuthentication" "OutgoingPassword" "OutgoingPasswordSameAsIncomingPassword" "OutgoingMailServerUseSSL" "VPNUUID" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-mail-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Mail (com.apple.mail.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}