  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "UserName" "EmailAddress" "Password" "OverridePreviousPassword" "Host" "SSL" "OAuth" "Certificate" "CertificateName" "CertificatePassword" "PreventMove" "PreventAppSheet" "SMIMEEnabled" "SMIMESigningEnabled" "SMIMESigningCertificateUUID" "SMIMEEncryptionEnabled" "SMIMEEncryptionCertificateUUID" "SMIMEEnablePerMessageSwitch" "SMIMESigningUserOverrideable" "SMIMESigningCertificateUUIDUserOverrideable" "SMIMEEncryptByDefault" "SMIMEEncryptByDefaultUserOverrideable" "SMIMEEncryptionCertificateUUIDUserOverrideable" "SMIMEEnableEncryptionPerMessageSwitch" "EnableCalendars" "EnableContacts" "EnableMail" "EnableNotes" "EnableReminders" "EnableCalendarsUserOverridable" "EnableContactsUserOverridable" "EnableMailUserOverridable" "EnableNotesUserOverridable" "EnableRemindersUserOverridable" "disableMailRecentsSyncing" "MailNumberOfPastDaysToSync" "CommunicationServiceRules" "VPNUUID" "HeaderMagic" "allowMailDrop" "OAuthSignInURL" "OAuthTokenRequestURL" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-eas-account" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Exchange ActiveSync (com.apple.eas.account) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}