...
in
{
  options.programs.macprofile.payloads."apple-com-apple-profileRemovalPassword" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Profile Removal Password (com.apple.profileRemovalPassword) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}