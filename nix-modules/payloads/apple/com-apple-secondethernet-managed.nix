# Auto-generated from ProfileManifests: com.apple.secondethernet.managed.plist
# Domain: com.apple.secondethernet.managed
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "802.1X Ethernet: Second";

      _domain = lib.mkOption {
        internal = true;
        type = lib.types.str;
        default = "com.apple.secondethernet.managed";
      ...
      Interface = lib.mkOption {
        type = types.nullOr (types.enum [ "SecondEthernet" ]);
        default = null;
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-secondethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: Second (com.apple.secondethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}