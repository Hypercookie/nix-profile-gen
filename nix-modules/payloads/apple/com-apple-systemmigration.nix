...
in
{
  options.programs.macprofile.payloads."apple-com-apple-systemmigration" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "System Migration (com.apple.systemmigration) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}