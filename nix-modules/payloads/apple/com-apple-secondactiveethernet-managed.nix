# Auto-generated from ProfileManifests: com.apple.secondactiveethernet.managed.plist
# Domain: com.apple.secondactiveethernet.managed
...
let
  payloadModule = {
    options = {
      enable = lib.mkEnableOption "802.1X Ethernet: Second Active";

      _domain = lib.mkOption {
        internal = true;
        type = lib.types.str;
        default = "com.apple.secondactiveethernet.managed";
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "SetupModes" "EAPClientConfiguration" "Interface" ];
      ...
      Interface = lib.mkOption {
        type = types.nullOr (types.enum [ "SecondActiveEthernet" ]);
        default = null;
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-secondactiveethernet-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "802.1X Ethernet: Second Active (com.apple.secondactiveethernet.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}