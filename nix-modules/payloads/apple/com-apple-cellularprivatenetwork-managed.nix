  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "Geofences" "DataSetName" "VersionNumber" "CellularDataPreferred" "EnableNRStandalone" "NetworkIdentifier" "CsgNetworkIdentifier" ];
...
in
{
  options.programs.macprofile.payloads."apple-com-apple-cellularprivatenetwork-managed" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Cellular Private Network (com.apple.cellularprivatenetwork.managed) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}