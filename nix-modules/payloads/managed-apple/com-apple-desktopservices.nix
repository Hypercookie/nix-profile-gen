  ...
  payloadModule = {
    options = {
      ...
      _keyNames = lib.mkOption {
        ...
        default = [ "DSDontWriteNetworkStores" ];
...
in
{
  options.programs.macprofile.payloads."managed-apple-com-apple-desktopservices" = lib.mkOption {
    type = types.attrsOf (types.submodule payloadModule);
    default = { };
    description = "Desktop Services (com.apple.desktopservices) payload instances, keyed by instance name. Use \"default\" if you only need one.";
  };
}